(function() {
  var CLIWatchPlugin, Jasmine, Neat, Q, commands, error, green, info, inverse, magenta, puts, red, yellow, _ref,
    ...
    Jasmine.prototype.runJasmine = function(path, paths) {
      ...
      if (paths.length > 0) {
        ...
        this.process = commands.run(jasmine, ['--coffee'].concat(paths), function(status) {
          var _ref1, _ref2;
          if (status === 0) {
            if ((_ref1 = _this.watcher) != null) {
              _ref1.notifier.notify({
                success: true,
                title: 'Jasmine',
