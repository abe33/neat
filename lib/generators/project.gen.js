...
(function() {
  ...
  usages('neat generate project <name> {description, author, keywords}', describe('Creates a <name> directory with the default neat project content\nDescription, author and keywords can be defined using the hash\narguments.', project = function() {
    ...
    try {
      ...
      touchSync(resolve(path, "src/config/environments/default.coffee"), render(resolve(tplpath, "src/config/environments/default"), context));
      touchSync(resolve(path, "src/config/environments/test.coffee"), render(resolve(tplpath, "src/config/environments/test"), context));
      touchSync(resolve(path, "src/config/environments/development.coffee"), render(resolve(tplpath, "src/config/environments/development"), context));
      touchSync(resolve(path, "src/config/environments/production.coffee"), render(resolve(tplpath, "src/config/environments/production"), context));
      ...
      touchSync(resolve(path, "src/config/initializers/docco.coffee"), render(resolve(tplpath, "src/config/initializers/docco"), context));
