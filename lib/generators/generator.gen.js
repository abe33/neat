...
(function() {
  var Neat, describe, ensurePathSync, error, fs, generator, missing, namespace, notOutsideNeat, puts, render, resolve, usages, utils, _ref, _ref1,
    __slice = [].slice;
  ...
  usages('neat generate generator [name]', describe('Generates a [name] generator in the generators directory', generator = function() {
    ...
    if (Neat.root == null) {
      return puts(notOutsideNeat("neat generate generator"));
    }
    if (name == null) {
