...
(function() {
  ...
  usages('neat generate generator <name>', describe('Generates a <name> generator in the generators directory', generator = namedEntity(__filename, 'src/generators', 'gen.coffee')));
