...
(function() {
  var Neat, cup, describe, dirWithIndexSync, error, exists, fs, index, info, namespace, puts, render, resolve, utils, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref1 = require(resolve(utils, "logs")), puts = _ref1.puts, error = _ref1.error, info = _ref1.info;
