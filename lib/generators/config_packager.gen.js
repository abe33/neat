...
(function() {
  ...
  usages('neat generate config:packager <name>', describe('Generates a <name> packager config in the config/packages directory', generator = namedEntity(__filename, 'config/packages', 'cup')));
