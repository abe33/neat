...
(function() {
  var Neat, describe, ensurePathSync, error, fs, info, initializer, missing, namespace, notOutsideNeat, puts, render, resolve, usages, utils, _ref, _ref1,
    __slice = [].slice;
  ...
  usages('neat generate initializer [name]', describe('Generates a [name] initializer in the config/initializers directory', initializer = function() {
    ...
    if (Neat.root == null) {
      return notOutsideNeat("neat generate initializer");
    }
    if (name == null) {
