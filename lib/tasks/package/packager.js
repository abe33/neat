...
(function() {
  var LITERAL_RE, NAME_RE, Neat, PACKAGE_RE, Packager, chain, compile, ensure, readFiles, writeFile, _, _ref;
  ...
  Packager = (function() {
    ...
    function Packager(conf) {
      ...
      malformedConf = function(key, type) {
        return new Error(_('neat.tasks.package.invalid_configuration', {
          key: key,
          type: type
        }));
      };
