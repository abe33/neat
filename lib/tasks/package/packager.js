  ...
  Packager = (function() {
    ...
    Packager.prototype.process = function(callback) {
      ...
      return readFiles(files, function(err, res) {
        ...
        _this.result = _this.processExports(content);
        _this.js = compile(_this.result, {
          bare: _this.conf.bare
        });
        return writeFile("" + tmp + "/" + _this.conf.name + ".coffee", _this.result, function(err) {
