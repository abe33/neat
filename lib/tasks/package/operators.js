...
(function() {
  ...
  preventMissingConf('package', validate('package', PACKAGE_RE(), _('neat.tasks.package.expected_package'), exportsToPackage = function(buffer, conf, callback) {
