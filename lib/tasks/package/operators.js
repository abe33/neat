...
(function() {
  var EXPORTS_RE, HASH_KEY_RE, HASH_RE, HASH_VALUE_RE, LITERAL_RE, MEMBER_RE, Neat, OBJECT_RE, REQUIRE_RE, SPLIT_MEMBER_RE, STRING_RE, coffee, compile, exportsToPackage, header, join, processExports, stripRequires, writeFile;
