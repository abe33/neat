...
(function() {
  var CLASS_MEMBER_RE, CLASS_RE, EXPORTS_RE, HASH_KEY_RE, HASH_RE, HASH_VALUE_RE, LITERAL_RE, MEMBER_RE, Neat, OBJECT_RE, REQUIRE_RE, SPLIT_MEMBER_RE, STRING_RE, analyze, annotateClass, annotateFile, cleanPath, coffee, compile, exportsToPackage, join, parallel, parser, pro, saveToFile, stripRequires, uglify, writeFile, _ref;
  ...
  analyze = function(path, content) {
    var comment, curClass, i, i2, line, m, out, p, s, _i, _len, _ref1, _ref2;
    out = content.concat();
    i2 = 0;
    curClass = null;
