...
(function() {
  var Neat, asyncErrorTrap, ensure, error, find, green, info, neatTask, puts, read, readFileSync, readFiles, red, rm, run, _ref, _ref1, _ref2;
  ...
  exports['package'] = neatTask({
    ...
    action: function(callback) {
      var conf, dir, _ref3;
      _ref3 = Neat.config.tasks["package"], dir = _ref3.dir, conf = _ref3.conf;
      return rm(dir, asyncErrorTrap(function() {
        return ensure(dir, asyncErrorTrap(function() {
          return find('cup', conf, asyncErrorTrap(function(files) {
            readFiles(files, function(err, res) {
              var c, p, _results;
              _results = [];
              for (p in res) {
                c = res[p];
                _results.push(console.log(read(c)));
              }
              return _results;
            });
