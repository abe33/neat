...
(function() {
  var COFFEE_LINT, Neat, error, find, green, info, neatTask, path, print, puts, queue, red, run, _ref, _ref1;
  ...
  _ref1 = Neat.require('utils/logs'), error = _ref1.error, info = _ref1.info, green = _ref1.green, red = _ref1.red, puts = _ref1.puts, print = _ref1.print;
