(function() {
  var COFFEE_LINT, Neat, asyncErrorTrap, error, find, findSiblingFile, fs, green, info, missing, neatTask, print, puts, queue, red, run, yellow, _, _ref, _ref1, _ref2;
  ...
  exports['lint'] = neatTask({
    ...
    action: function(callback) {
      var dir, err, path, paths;
      if (!fs.existsSync(COFFEE_LINT)) {
