(function() {
  var Neat, beforeTests, error, functional, green, index, info, integration, namespace, neatTask, path, puts, queue, red, runTests, unit, yellow, _, _ref;
    ...
    action: beforeTests(function(callback) {
      return runTests('unit', 'test/units')(function(statusUnit) {
        return runTests('functional', 'test/functionals')(function(statusFunctional) {
          return runTests('integration', 'test/integrations')(function(statusIntegration) {
            var status, statuses;
  ...
  integration = neatTask({
    ...
    environment: 'test',
    action: beforeTests(function(callback) {
      return runTests('integration', 'test/integrations')(function(status) {
        if (status === 0) {
          info(green(_('neat.tasks.test.tests_done')));
        } else {
          error(red(_('neat.tasks.test.tests_failed')));
