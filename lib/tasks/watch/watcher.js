(function() {
  var Neat, Q, Watch, Watcher, asyncErrorTrap, compile, cyan, error, existsSync, fs, green, inverse, parallel, path, puts, red, warn, yellow, _ref,
    _this = this;
  ...
  Watcher = (function() {
    ...
    Watcher.prototype.init = function() {
      ...
      process.on('SIGINT', function() {
        var _ref1;
        if ((_ref1 = _this.activePlugin) != null ? _ref1.isPending() : void 0) {
          puts(yellow("\n" + _this.activePlugin + " interrupted"));
          return _this.activePlugin.kill('SIGINT');
        } else {
