(function() {
  var Neat, Q, Watch, Watcher, asyncErrorTrap, compile, cyan, error, existsSync, fs, green, n, parallel, path, puts, red, warn, yellow, _ref,
    _this = this;
  ...
  _ref = Neat.require('utils/logs'), warn = _ref.warn, error = _ref.error, puts = _ref.puts, yellow = _ref.yellow, green = _ref.green, red = _ref.red, cyan = _ref.cyan;
  ...
  Watcher = (function() {
    ...
    Watcher.prototype.dispose = function() {
      ...
      promise = Q.fcall(function() {
        ...
        return _this.ignoredPaths = null;
      });
      _ref1 = this.plugins;
      for (k in _ref1) {
        plugin = _ref1[k];
    ...
    Watcher.prototype.pathChanged = function(path, action) {
      var name, p, plugin, promise, _ref1;
      switch (path) {
        case Neat.resolve('Watchfile'):
        case Neat.resolve('.watchignore'):
          promise = this.promise.then(this.dispose).then(this.init);
          break;
        default:
          _ref1 = this.plugins;
          for (name in _ref1) {
      ...
      watcher = function(name, options, block) {
        ...
        if (name in plugins) {
          if ((_ref2 = (_base = _this.plugins)[name]) == null) {
            _base[name] = new plugins[name](options);
          }
          currentWatcher = name;
          return block.call();
        } else {
