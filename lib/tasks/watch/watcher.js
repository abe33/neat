(function() {
  var Neat, Q, Watch, Watcher, asyncErrorTrap, compile, cyan, error, fs, green, inverse, n, os, parallel, path, puts, red, rl, warn, yellow, _ref,
  ...
  Watcher = (function() {
    ...
    Watcher.prototype.rewatch = function(file, watcher) {
      ...
      return this.watches[file] = fs.watch(file, function(action) {
        ...
        if (exist) {
          ...
          _this.watchedPaths.splice(_this.watchedPaths.indexOf(file, 1));
          return delete _this.watches[file];
        }
      });
    };
    ...
    Watcher.prototype.displayHelp = function() {
      puts("" + (cyan('↩, a, all')) + ": Run all plugins.\n" + (cyan('h, help')) + ": Print this message.\n" + (cyan('q, quit, e, exit')) + ": Kill cake watch.");
      return this.cli.prompt();
    };
