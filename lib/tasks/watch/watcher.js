(function() {
  ...
  Watcher = (function() {
    ...
    function Watcher() {
      var _this = this;
      this.lineListener = function(line) {
        return Watcher.prototype.lineListener.apply(_this, arguments);
      };
      this.keypressListener = function(s, key) {
        return Watcher.prototype.keypressListener.apply(_this, arguments);
      };
      this.sigintListener = function() {
        return Watcher.prototype.sigintListener.apply(_this, arguments);
      };
      this.startCLI = function() {
        return Watcher.prototype.startCLI.apply(_this, arguments);
      };
