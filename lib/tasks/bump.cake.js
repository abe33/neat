...
(function() {
  ...
  bump = function(majorBump, minorBump, buildBump, callback) {
    ...
    newVersion = null;
    replaceVersion = function(callback) {
      return function(err, data) {
        var replaceFunc;
        if (err != null) {
          return typeof callback === "function" ? callback(new Error("Can't find .neat file")) : void 0;
        }
        ...
        return typeof callback === "function" ? callback(null, data.toString().replace(re, replaceFunc)) : void 0;
      };
    };
