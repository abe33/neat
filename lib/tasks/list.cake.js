...
(function() {
  var Neat, error, first, green, info, last, length, neatTask, property, puts, red, run, _ref, _ref1, _ref2;
  ...
  exports['list'] = neatTask({
    ...
    action: function(callback) {
      ...
      puts(("" + ('Task'.left(c1)) + ('Environment'.left(c2))).yellow, 5);
      for (k in tasks) {
        v = tasks[k];
