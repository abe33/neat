...
(function() {
  var Neat, aliases, cmds, describe, error, findSiblingFile, fs, help, missing, neatBroken, puts, render, renderSync, resolve, run, usages, utils, warn, withHelp, _ref, _ref1, _ref2,
    __slice = [].slice;
  ...
  _ref2 = require(cmds), run = _ref2.run, aliases = _ref2.aliases, usages = _ref2.usages, describe = _ref2.describe, withHelp = _ref2.help;

  help = function(pr, commands) {
    var f;
    if (pr == null) {
      return puts(error("No program provided to help"));
    }
    if (commands == null) {
      return puts(error("No commands map provided"));
    }
