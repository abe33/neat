...
(function() {
  var Neat, aliases, describe, environment, error, generate, help, helpCmd, missing, puts, render, resolve, run, usages, utils, warn, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref1 = require(resolve(utils, "commands")), run = _ref1.run, aliases = _ref1.aliases, usages = _ref1.usages, describe = _ref1.describe, help = _ref1.help, environment = _ref1.environment;
  ...
  generate = function(pr, commands) {
    ...
    aliases('g', 'generate', environment('production', usages('neat generate [generator]', describe('Runs the specified [generator]', f = function() {
      ...
      if (!(generator in generators)) {
        return typeof callback === "function" ? callback(new Error(missing("Generator " + generator))) : void 0;
      ...
      if (typeof gen !== "function") {
        return typeof callback === "function" ? callback(new Error(("Generators must be a function,                                  was " + (typeof gen)).squeeze())) : void 0;
      }
