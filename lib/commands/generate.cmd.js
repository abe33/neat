(function() {
  var Neat, aliases, describe, environment, error, generate, help, helpCmd, missing, puts, render, resolve, run, usages, warn, _, _ref, _ref1,
    __slice = [].slice;
  ...
  generate = function(pr, commands) {
    ...
    aliases('g', 'generate', environment('production', usages('neat generate [generator]', describe(_('neat.commands.generate.description'), f = function() {
      ...
      if (!(generator in generators)) {
        return typeof callback === "function" ? callback(new Error(missing(_('neat.commands.generate.generator', {
          generator: generator
        })))) : void 0;
