...
(function() {
  ...
  DoccoPreProcessor = (function() {
    ...
    function DoccoPreProcessor(path, content) {
      this.path = path;
    ...
    DoccoPreProcessor.prototype.hasTags = function() {
      return this.content.docs_html.indexOf('<pre><code>', this.cursor) !== -1;
    };

    DoccoPreProcessor.prototype.processTag = function(callback) {
      var content, endTagPos, pre, startTagPos,
        _this = this;
      startTagPos = this.content.docs_html.indexOf(START_TAG, this.cursor);
      endTagPos = this.content.docs_html.indexOf(END_TAG, this.cursor);
      content = this.content.docs_html.substring(startTagPos + START_TAG.length, endTagPos);
      pre = {
        docs_text: '',
      ...
      return highlight(this.path, [pre], function() {
        ...
        _this.content.docs_html = _this.content.docs_html.replace(match, pre.code_html);
