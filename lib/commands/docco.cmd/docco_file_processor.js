...
(function() {
  var DoccoFileProcessor, DoccoPreProcessor, DoccoTitleProcessor, error, fs, highlight, parallel, parse, puts, render, resolve, _ref, _ref1;
        ...
        return _this.highlightFile(_this.file.path, sections, function(toc) {
          ...
          return render(TPL_PATH, context, function(err, page) {
            ...
            return fs.writeFile(_this.file.outputPath, page, function(err) {
              ...
              puts("" + _this.file.relativePath.yellow + " documentation processed", 1);
