...
(function() {
  var DoccoFileProcessor, DoccoPreProcessor, DoccoTitleProcessor, Neat, error, fs, highlight, missing, parallel, parse, puts, render, resolve, showdown, _, _ref;
  ...
  try {
    ...
    showdown = require("" + Neat.neatRoot + "/node_modules/docco/vendor/showdown").Showdown;
  } catch (e) {
