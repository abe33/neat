(function() {
  var DoccoFileProcessor, DoccoPreProcessor, DoccoTitleProcessor, Neat, SHOWDOWN, error, fs, highlight, missing, parallel, parse, puts, render, resolve, showdown, _, _ref;
