...
(function() {
  var DoccoFile, Neat, Processor, aliases, basename, describe, docco, ensureSync, error, existsSync, extname, fs, info, missing, neatBroken, parallel, relative, render, resolve, utils, warn, _ref, _ref1, _ref2;
  ...
  _ref1 = require(resolve(utils, 'logs')), error = _ref1.error, info = _ref1.info, warn = _ref1.warn, missing = _ref1.missing, neatBroken = _ref1.neatBroken;
  ...
  docco = function(pr) {
    var f;
    if (pr == null) {
      return error('No program provided to docco');
    }
