...
(function() {
  var DoccoFile, Neat, Processor, aliases, basename, cmdgen, desc, describe, documentation, ensureSync, error, existsSync, extname, fs, green, index, info, missing, name, namespace, parallel, relative, render, resolve, stylesheet, warn, _ref, _ref1, _ref2;
  ...
  _ref2 = Neat.require('utils/commands'), aliases = _ref2.aliases, describe = _ref2.describe;
  ...
  cmdgen = function(name, desc, fn) {
    return function(pr) {
      ...
      return aliases(name, describe(desc, f = function(callback) {
        if (Neat.root == null) {
