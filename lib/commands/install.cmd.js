...
(function() {
  var COFFEE, Neat, aliases, describe, error, fs, generate, green, info, install, puts, red, render, resolve, run, _, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref = Neat.require("utils/logs"), puts = _ref.puts, error = _ref.error, info = _ref.info, green = _ref.green, red = _ref.red;

  _ref1 = Neat.require("utils/commands"), run = _ref1.run, aliases = _ref1.aliases, describe = _ref1.describe;
  ...
  install = function(pr) {
    ...
    return aliases('i', 'install', describe(_('neat.commands.install.description'), f = function() {
      var args, callback, _i;
      args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), callback = arguments[_i++];
      if (Neat.root == null) {
        throw new Error(_("neat.errors.outside_neat", {
          expression: 'neat install'
        }));
      }
      return fs.readFile('Nemfile', function(err, nemfile) {
        if (err) {
          throw new Error(_('neat.commands.install.no_nemfile'));
        }
        puts("Nemfile found");
