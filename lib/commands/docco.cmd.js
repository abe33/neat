...
(function() {
  var DoccoFile, Neat, REQUIRE_RE, aliases, basename, describe, docco, ensureSync, error, existsSync, extname, fs, missing, neatBroken, puts, relative, render, resolve, utils, warn, _ref, _ref1, _ref2;
  ...
  docco = function(pr) {
    ...
    return aliases('docco', describe('Generates the documentation for a Neat project through docco', f = function(callback) {
      var files, headerTplPath, highlight, navTplPath, pageTplPath, parse, path, paths, _ref3;
      if (Neat.root == null) {
      ...
      return render(navTplPath, {
        ...
        return render(headerTplPath, {
          ...
          var generateDocumentation, nextFile;
          if (err != null) {
            throw err;
          }
          generateDocumentation = function(file, sources, callback) {
            return fs.readFile(file.path, function(err, code) {
              ...
              return highlight(file.path, sections, function() {
                var context;
                context = {
                  sections: sections,
                  header: header,
