...
(function() {
  ...
  String.prototype.center = function(width, pad) {
  ...
  String.prototype.padLeft = function(length, pad) {
    if (length == null) {
      length = 0;
    }
    if (pad == null) {
  ...
  String.prototype.padRight = function(length, pad) {
    if (length == null) {
      length = 0;
    }
    if (pad == null) {
  ...
  String.prototype.squeeze = function(match) {
  ...
  String.prototype.to = function(end, callback) {
