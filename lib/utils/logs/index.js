...
(function() {
  var Logger, Signal, blue, color, colors, cyan, debug, error, green, info, inverse, logger, magenta, missing, neatBroken, notOutsideNeat, prefix, print, puts, red, warn, yellow;
