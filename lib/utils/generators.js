(function() {
  var Neat, describe, ensurePathSync, error, fs, green, hashArguments, info, missing, multiEntity, namedEntity, noExtension, notOutsideNeat, relative, render, resolve, usages, _, _ref, _ref1, _ref2, _ref3,
    __slice = [].slice;
  ...
  _ref1 = Neat.require('utils/files'), ensurePathSync = _ref1.ensurePathSync, noExtension = _ref1.noExtension;

  _ref2 = Neat.require('utils/commands'), describe = _ref2.describe, usages = _ref2.usages, hashArguments = _ref2.hashArguments;

  render = Neat.require('utils/templates').render;

  _ref3 = Neat.require('utils/logs'), error = _ref3.error, info = _ref3.info, green = _ref3.green, missing = _ref3.missing, notOutsideNeat = _ref3.notOutsideNeat;
  ...
  multiEntity = function(src, entities, ctx, requireNeat) {
    ...
    return function() {
      ...
      return entities.each(function(k, v) {
        ...
        context = k === 'unit' || k === 'functional' ? ctx.concat({
          relative: relative,
