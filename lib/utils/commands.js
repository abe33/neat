(function() {
  var Neat, aliases, asyncErrorTrap, decorate, describe, environment, error, hashArguments, help, neatTask, neatTaskAlias, print, puts, resolve, run, spawn, usages, _, _ref,
    __slice = [].slice,
      ...
      return Neat.initEnvironment(function() {
        return Neat.beforeTask.dispatch(function() {
          return action(function(status) {
            return Neat.afterTask.dispatch(status);
          });
        });
      });
    };
  ...
  neatTaskAlias = function(source, alias) {
    return neatTask({
      name: alias,
