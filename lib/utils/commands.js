(function() {
  var Neat, aliases, asyncErrorTrap, cp, decorate, deprecated, describe, environment, error, hashArguments, help, neatTask, neatTaskAlias, print, puts, resolve, run, usages, _, _ref,
    __slice = [].slice,
