...
(function() {
  var Neat, error, extname, findSiblingFileSync, fs, missing, neatBroken, puts, render, renderSync, resolve, warn, _ref, _ref1;
  ...
  findSiblingFileSync = require("../utils/files").findSiblingFileSync;
