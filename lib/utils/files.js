...
(function() {
  ...
  findSiblingFile = function() {
    ...
    return neatRoot(path, function(pathRoot) {
      ...
      if (pathRoot == null) {
        return typeof callback === "function" ? callback(new Error('')) : void 0;
      }
