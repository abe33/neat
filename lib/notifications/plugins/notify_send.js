(function() {
  var Neat, NotificationPlugin, NotifySend, notify_send, _,
  ...
  NotifySend = (function(_super) {
    ...
    function NotifySend() {
      return NotifySend.__super__.constructor.apply(this, arguments);
    }
    ...
    NotifySend.prototype.notify = function(notification, callback) {
      ...
      Neat.resolve(icon);
      return notify_send.notify(notification.title, callback);
    };
