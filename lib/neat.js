...
(function() {
  var NEAT_ROOT, Neat, Signal, cup, error, exists, findSync, fs, isNeatRootSync, logger, missing, neatBroken, neatRootSync, pr, puts, resolve, warn, _ref, _ref1, _ref2,
  ...
  Neat = (function() {
    ...
    Neat.prototype.initEnvironment = function() {
      this.setEnvironment(process.env['NEAT_ENV'] || this.defaultEnvironment);
      return this.initLogging();
    };

    Neat.prototype.setEnvironment = function(env) {
      var configurator, configurators, envObject, f, files, initialize, initializer, initializers, o, paths, setup, _i, _j, _k, _len, _len1, _len2,
        _this = this;
      envObject = {
        root: this.root,
      ...
      this.CONFIG = this.config = envObject;
      o = {};
      o[env] = true;
      return this.ENV = this.env = Object.prototype.merge.call(env, o);
    };
