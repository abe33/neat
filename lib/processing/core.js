(function() {
  var Neat, Q, check, checkBuffer, exists, fileFooter, fileHeader, fs, join, parallel, path, processExtension, readFiles, relocate, remove, utils, writeFiles, _ref;
